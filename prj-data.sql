...
insert into agents values (1, 'Ronaldo', 'Ro');
insert into agents values (2, 'Messi',   'Me');
insert into agents values (3, 'Ramos',   'Ra');
insert into agents values (4, 'Bale',    'Ba');
...
insert into categories values ('bath', 'Bathing');
...
insert into customers values ('c10', 'Abraham', 'CS Dept, University of Alberta', 'Ab');
insert into customers values ('c20', 'Samson', '9632-107 Ave', 'Sa');
insert into customers values ('c30', 'Connor', '111-222 Ave', 'Co');
insert into customers values ('c40', 'Sam', '9702-162 St NW', 'Sa');
insert into customers values ('c50', 'Bryanna', '391 Richfield Rd', 'Br');
insert into customers values ('c60', 'John', '11 Knottwood Rd', 'Jo');
insert into customers values ('c70', 'Ronaldo', '8012-122 St SW', 'Ro');
insert into customers values ('c80', 'Messi', '54 Elanore Dr', 'Me');
...
insert into orders values (240, 'c40', datetime('now', '-8 hours'), '5108-12 St NW');
insert into orders values (250, 'c40', datetime('now', '-10 hours'), '52 St SW');
insert into orders values (260, 'c40', datetime('now', '-1 hours'), '5108-12 St NW');
insert into orders values (270, 'c40', datetime('now', '-15 hours'), '97-66 Ave West');
...
insert into olines values (240, 20, 'p20', 3, 9.8);
insert into olines values (250, 20, 'p40', 10, 6.8);
insert into olines values (260, 20, 'p70', 4, 3.1);
insert into olines values (270, 20, 'p50', 9, 2.7);
...
insert into deliveries values (1014,240,datetime('now', '-8 days'), datetime('now', '-1 day'));
insert into deliveries values (1015,250,datetime('now', '-10 days'), datetime('now', '-8 day'));
insert into deliveries values (1016,260,datetime('now', '+2 days'), datetime('now', '-9 day'));
insert into deliveries values (1017,270,datetime('now', '+5 days'), datetime('now', '-1 day'));
